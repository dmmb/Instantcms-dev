...
`menu_id` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=537;
...
DROP TABLE IF EXISTS `#__user_profile_visitor`;
CREATE TABLE `#__user_profile_visitor` (  
`user_id` int(11) NOT NULL,  
...
INSERT INTO `#__banners` (`id`, `position`, `typeimg`, `fileurl`, `hits`, `clicks`, `maxhits`, `maxuser`, `user_id`, `pubdate`, `title`, `link`, `published`) VALUES ('4','banner1','image','banner468x60v1.gif','0','0','0','0','1','2009-04-04 19:43:53','InstantCMS - Бесплатная система управления сайтом','http://www.instantcms.ru/','1');

INSERT INTO `#__blog_authors` (`id`, `user_id`, `blog_id`, `description`, `startdate`) VALUES ('21','1','1','','2009-05-13 12:07:38'),
 ('26','21','14','','2009-05-26 10:33:59'),
 ('25','1','14','','2009-05-26 10:33:59'),
 ('32','25','17','','2009-08-19 12:00:33'),
 ('31','21','17','','2009-08-19 12:00:33');

INSERT INTO `#__blog_cats` (`id`, `blog_id`, `title`) VALUES ('2','14','test');

INSERT INTO `#__blog_posts` (`id`, `user_id`, `cat_id`, `blog_id`, `pubdate`, `title`, `feel`, `music`, `content`, `allow_who`, `edit_times`, `edit_date`, `published`, `seolink`) VALUES ('5','1','0','1','2009-08-29 14:47:00','Пример записи в блоге','','','[b]Блоги InstantCMS - это мощный и надежный инструмент для ваших публикаций:[/b]\r\n\r\n- Редактор BB-кода (скрытый текст, ссылки, цитаты, картинки);\r\n- Вставка изображений "на лету";\r\n- Неограниченное число рубрик;\r\n- Комментарии к записям;\r\n- Возможность ведения коллективных блогов;\r\n- Смайлы и теги;','0','2','2009-08-29 14:47:00','1','primer-zapisi-v-bloge');

INSERT INTO `#__blogs` (`id`, `user_id`, `title`, `pubdate`, `allow_who`, `view_type`, `showcats`, `ownertype`, `premod`, `forall`, `owner`, `seolink`) VALUES ('1','1','Пример блога','2008-06-03 13:26:55','all','list','1','single','0','1','user','primer-bloga'),
 ('21','13','Блог','2009-08-29 14:04:46','all','list','1','multi','0','0','club','phpclub');
...
INSERT INTO `#__category` (`id`, `parent_id`, `title`, `description`, `published`, `showdate`, `showcomm`, `orderby`, `orderto`, `modgrp_id`, `NSLeft`, `NSRight`, `NSLevel`, `NSDiffer`, `NSIgnore`, `ordering`, `maxcols`, `showtags`, `showrss`, `showdesc`, `is_public`, `photoalbum`, `seolink`) VALUES ('1','0','--Корневой раздел--','Корневой раздел сайта','1','1','1','pubdate','asc','0','1','14','0','','0','1','1','1','1','0','0','','--kornevoi-razdel--'),
...
INSERT INTO `#__clubs` (`id`, `admin_id`, `title`, `description`, `imageurl`, `pubdate`, `clubtype`, `published`, `maxsize`, `enabled_blogs`, `enabled_photos`, `rating`, `photo_premod`, `blog_premod`, `blog_min_karma`, `photo_min_karma`, `album_min_karma`, `join_min_karma`, `join_karma_limit`) VALUES ('13','21','PHPClub','','','2009-08-29 14:04:46','public','1','0','1','1','0','0','0','0','0','25','0','0');

INSERT INTO `#__comments` (`id`, `parent_id`, `pid`, `user_id`, `target`, `target_id`, `guestname`, `content`, `pubdate`, `published`, `is_new`) VALUES ('1','0','0','1','article','30','','Отличная статья! Большое спасибо автору!','2009-05-20 17:42:14','1','1'),
 ('2','1','0','21','article','30','','Согласен с Вами, коллега!','2009-05-20 17:42:40','1','1'),
 ('4','0','0','0','article','31','спамер','моя [url=http://www.ya.ru/]спамерская ссылка[/url]','2009-07-08 13:20:33','1','1'),
 ('5','0','0','1','article','31','','но бывают и [url=/images/rss.png]нормальные[/url] ссылки','2009-07-08 13:21:12','1','1');

INSERT INTO `#__components` (`id`, `title`, `link`, `config`, `internal`, `author`) VALUES ('1','Каталог статей','content','---\nshowtitle: 0\nreaddesc: 0\nrating: 1\nperpage: 10\npt_show: 0\npt_disp: 0\npt_hide: 0\nautokeys: 1\naf_on: 0\naf_delete: 1\naf_showlink: 1\naf_forum_id: 1\naf_hidecat_id: 2\n','0','InstantCMS team'),
...
INSERT INTO `#__content` (`id`, `category_id`, `user_id`, `pubdate`, `enddate`, `is_end`, `title`, `description`, `content`, `published`, `hits`, `meta_desc`, `meta_keys`, `showtitle`, `showdate`, `showlatest`, `showpath`, `ordering`, `comments`, `is_arhive`, `seolink`, `canrate`, `pagetitle`) VALUES ('20','2','1','2009-03-01 15:56:00','2009-05-22','0','Наш сайт открыт!','<p>Мы рады приветствовать вас на нашем сайте!</p>','<p>Наш сайт открыт и начинает активно фунционировать.</p>\r\n<p>У нас большие планы на будущее. На этом сайте мы постарались разместить интересную информацию.</p>\r\n<p>Мы очень рады что вы читаете эту новость.</p>\r\n<p>Наша компания занимается бизнесом в сфере продажи строительных материалов.</p>','1','377','','','1','1','1','1','1','1','0','novosti/nash-sait-otkryt','1',''),
...
INSERT INTO `#__faq_quests` (`id`, `category_id`, `pubdate`, `published`, `quest`, `answer`, `user_id`, `answeruser_id`, `answerdate`, `hits`) VALUES ('3','3','2008-04-14 20:09:54','1','У меня не работает чайник. Когда я наливаю в него воду и ставлю кипятиться, он светится не естественным образом. Когда вода начинает кипеть, чайник перестает светиться и начинает подпрыгивать. Один раз он упрыгал в ванну.\r\n\r\nПодскажите, как мне его починить?','<p>Василий, ваша проблема встречается очень часто. И, к сожалению, вряд ли вам чем-то можно помочь. Единственное, что мы можем - это заявить на вас в милицию. Так что решайте, что вам дороже.</p>','2','1','2008-04-14 20:09:54','27'),
...
INSERT INTO `#__form_fields` (`id`, `form_id`, `title`, `ordering`, `kind`, `mustbe`, `config`) VALUES ('8','1','Ваше имя:','1','text','1','a:3:{s:3:"max";s:3:"200";s:4:"size";s:2:"30";s:7:"default";s:0:"";}'),
...
INSERT INTO `#__forms` (`id`, `title`, `description`, `email`, `sendto`, `user_id`) VALUES ('1','Написать письмо','<p>Используйте эту форму для обратной связи!</p>','forms@cms.ru','user','1'),
 ('3','Анкета пользователя','','','mail','1');

INSERT INTO `#__forum_cats` (`id`, `title`, `published`, `auth_group`, `ordering`) VALUES ('1','Общие вопросы','1','0','1');

INSERT INTO `#__forum_posts` (`id`, `thread_id`, `user_id`, `pubdate`, `editdate`, `edittimes`, `content`) VALUES ('29','12','1','2009-04-04 18:54:53','2009-06-19 11:46:32','1','Геосинклиналь [b]обогащает магматический монтмориллонит[/b], что в общем свидетельствует о преобладании тектонических опусканий в это время. Углефикация характерна. Порода существенна. Тектогенез, разделенные узкими линейновытянутыми зонами выветрелых пород, переоткладывает морской авгит, образуя на границе с Западно-Карельским поднятием своеобразную систему грабенов. Ведущий экзогенный геологический процесс - субдукция ослабляет лакколит, так как совершенно однозначно указывает на существование и рост в период оформления палеогеновой поверхности выравнивания.');

INSERT INTO `#__forum_threads` (`id`, `forum_id`, `user_id`, `title`, `description`, `icon`, `pubdate`, `hits`, `closed`, `pinned`, `rel_to`, `rel_id`) VALUES ('12','1','1','Пример темы','','','2009-07-03 13:20:51','45','0','0','','0');

INSERT INTO `#__forums` (`id`, `category_id`, `title`, `description`, `auth_group`, `ordering`, `published`, `parent_id`, `NSLeft`, `NSRight`, `NSDiffer`, `NSIgnore`, `NSLevel`) VALUES ('1000','0','-- Корень форумов --','','0','1','0','0','1','6','','0','1'),
 ('1','1','Общий форум','','0','1','1','1000','2','5','','0','2'),
 ('1002','1','Подфорум1','','2','2','1','1','3','4','','0','3');
...
INSERT INTO `#__menu` (`id`, `menu`, `title`, `link`, `linktype`, `linkid`, `target`, `component`, `ordering`, `published`, `template`, `allow_group`, `iconurl`, `NSLeft`, `NSRight`, `NSLevel`, `NSDiffer`, `NSIgnore`, `parent_id`) VALUES ('1','root','-- Главная страница --','','link','-1','_self','','1','0','0','-1','','1','30','0','','0','0'),
 ('10','mainmenu','Новости','/index.php?view=content&id=2','category','2','_self','','1','1','0','-1','01.gif','2','3','1','','0','1'),
 ('13','mainmenu','Вопросы и ответы','/index.php?view=faq','component','faq','_self','','6','1','0','-1','27.gif','12','13','1','','0','1'),
 ('15','mainmenu','Пользователи','/index.php?view=users','component','users','_self','','11','1','0','-1','group.gif','22','23','1','','0','1'),
 ('16','mainmenu','Регистрация','/index.php?view=registration','component','registration','_self','','13','1','0','8','tag.gif','26','27','1','','0','1'),
 ('17','mainmenu','Блоги','/index.php?view=blog','component','blog','_self','','4','1','0','-1','blog.gif','8','9','1','','0','1'),
 ('18','mainmenu','Форумы','/index.php?view=forum','component','forum','_self','','12','1','0','-1','29.gif','24','25','1','','0','1'),
 ('20','mainmenu','Фотогалерея','/index.php?view=photos','component','photos','_self','','3','1','0','-1','20.gif','6','7','1','','0','1'),
 ('21','mainmenu','Статьи','/index.php?view=content&id=6','category','6','_self','','2','1','0','-1','22.gif','4','5','1','','0','1'),
 ('22','mainmenu','Прайс-лист','/index.php?view=price','component','price','_self','','7','1','0','-1','objects043.gif','14','15','1','','0','1'),
 ('23','mainmenu','Универсальный каталог','/index.php?view=catalog','component','catalog','_self','','8','1','0','-1','objects048.gif','16','17','1','','0','1'),
 ('25','mainmenu','Поиск по сайту','/index.php?view=search','component','search','_self','','10','1','0','-1','objects018.gif','20','21','1','','0','1'),
 ('27','mainmenu','Админка','/admin/','link','/admin/','_blank','','14','1','0','2','options.gif','28','29','1','','0','1'),
 ('37','mainmenu','Доска объявлений','/index.php?view=board','component','board','_self','','9','1','0','-1','objects038.gif','18','19','1','','0','1'),
 ('38','mainmenu','Клубы','/index.php?view=clubs','component','clubs','_self','','5','1','0','-1','45.gif','10','11','1','','0','1');
...
INSERT INTO `#__modules` (`id`, `position`, `name`, `title`, `is_external`, `content`, `ordering`, `showtitle`, `published`, `user`, `config`, `original`, `css_prefix`, `allow_group`, `cache`, `cachetime`, `cacheint`, `template`) VALUES ('1','left','Меню','Меню','1','mod_menu','6','1','1','0','---\nmenu: mainmenu\njtree: 1\n','1','','-1','0','1','HOUR','module.tpl'),
 ...
 ('25','right','Голосования','Голосования','1','mod_polls','7','1','1','0','---\nshownum: 0\npoll_id: 2\n','1','','-1','0','1','HOUR','module.tpl'),
 ...
 ('39','right','Выбор шаблона','Выбор шаблона','1','mod_template','12','1','1','0','---\n','1','','-1','0','1','HOUR','module.tpl'),
...
INSERT INTO `#__modules_bind` (`id`, `module_id`, `menu_id`) VALUES ('329','42','0'),
 ('249','31','0'),
 ('533','17','1'),
 ('347','41','18'),
 ('498','39','1'),
...
INSERT INTO `#__photo_albums` (`id`, `parent_id`, `ordering`, `NSLeft`, `NSRight`, `NSDiffer`, `NSIgnore`, `NSLevel`, `title`, `description`, `published`, `showdate`, `iconurl`, `pubdate`, `orderby`, `orderto`, `public`, `perpage`, `cssprefix`, `thumb1`, `thumb2`, `thumbsqr`, `showtype`, `nav`, `uplimit`, `maxcols`, `orderform`, `showtags`, `bbcode`, `user_id`, `is_comments`) VALUES ('100','0','1','1','4','','0','0','-- Корневой альбом --','','1','1','','2008-05-30 12:03:07','title','asc','0','15','','96','480','1','list','1','0','4','1','1','1','1','0'),
...
INSERT INTO `#__photo_files` (`id`, `album_id`, `title`, `description`, `pubdate`, `file`, `published`, `hits`, `showdate`, `comments`, `user_id`, `owner`) VALUES ('10','1','Закат на пляже','','2009-08-31 18:26:43','d3ebb2e099da3925c1c91b521995105b.jpg','1','1','1','1','1','photos'),
 ('11','1','Флорида','','2009-08-31 18:27:33','eaefcc0294b1edaca95800a0e6fe6a9e.jpg','1','0','1','1','1','photos');

INSERT INTO `#__plugins` (`id`, `plugin`, `title`, `description`, `author`, `version`, `plugin_type`, `published`, `config`) VALUES ('6','p_usertab','Demo Profile Plugin','Пример плагина - Добавляет вкладку "Статьи" в профили всех пользователей','InstantCMS Team','1.0','plugin','0','---\nКоличество статей: 10\n'),
...
INSERT INTO `#__polls` (`id`, `title`, `pubdate`, `answers`) VALUES ('2','Какой у вас хостинг?','2008-05-23','a:3:{s:7:"Платный";i:0;s:10:"Бесплатный";i:0;s:11:"Собственный";i:0;}');

INSERT INTO `#__price_cats` (`id`, `title`, `description`, `published`) VALUES ('4','Плакаты и агитационные  материалы','','1'),
 ('5','Обучающие видеофильмы','','1'),
 ('6','Бланки','<p>бла бла бланки</p>','1'),
 ('9','Нормативно-техническая документация','','1');

INSERT INTO `#__price_items` (`id`, `category_id`, `title`, `price`, `published`, `canmany`) VALUES ('688','9','Учет тепловой энергии и теплоносителя. Энергосервис, Москва, 2004 год','170','1','1'),
...
INSERT INTO `#__tags` (`id`, `tag`, `target`, `item_id`) VALUES ('235','пример','photo','11'),
 ('234','фото','photo','10'),
 ('233','пример','photo','10'),
 ('236','фото','photo','11'),
 ...
 ('90','макет сайта','userphoto','6'),
 ('89','дизайн','userphoto','6'),
 ('223','астрономия','content','29'),
 ('232','блог','blogpost','5'),
 ('231','пример','blogpost','5'),
 ...
 ('168','психология','content','36'),
 ('167','статья','content','36'),
 ('169','пример','content','36'),
 ('172','пример','content','35');

INSERT INTO `#__uc_cats` (`id`, `parent_id`, `title`, `description`, `published`, `fieldsstruct`, `view_type`, `fields_show`, `showmore`, `perpage`, `showtags`, `showsort`, `is_ratings`, `orderby`, `orderto`, `showabc`, `shownew`, `newint`, `filters`, `is_shop`) VALUES ('1','0','Канцелярские принадлежности','','1','a:6:{i:0;s:12:"Артикул/~m~/";i:1;s:10:"Цвета/~m~/";i:2;s:18:"Минимальная партия";i:3;s:13:"Описание/~h~/";i:4;s:11:"Размер/~m~/";i:5;s:12:"Скачать/~l~/";}','shop','2','1','10','1','1','1','pubdate','','1','1','2 DAY','1','0'),
 ('2','0','Автомобили','','1','a:4:{i:0;s:15:"Тип кузова/~m~/";i:1;s:15:"Объем двигателя";i:2;s:16:"Год выпуска/~m~/";i:3;s:13:"Описание/~h~/";}','list','10','1','20','0','1','1','pubdate','','1','1','2 DAY','0','0');

INSERT INTO `#__uc_discount` (`id`, `title`, `cat_id`, `sign`, `value`, `unit`, `if_limit`) VALUES ('2','Почтовые расходы','0','2','200','руб.','0'),
 ('3','Скидка на канц.товары','1','-1','15','%','0');

INSERT INTO `#__uc_items` (`id`, `category_id`, `title`, `pubdate`, `published`, `imageurl`, `fieldsdata`, `hits`, `is_comments`, `tags`, `rating`, `meta_desc`, `meta_keys`, `price`, `canmany`) VALUES ('1','1','Карандаши','2008-06-03 13:38:55','1','b00117f6bca1efaaef37b44da87c1100.jpg','a:4:{i:0;s:7:"3130070";i:1;s:7:"бежевый";i:2;s:7:"191 шт.";i:3;s:64:"Набор для рисования: 12 цветных карандашей в картонной коробочке";}','25','1','пастель, карандаши','0','','','14.6','1'),
 ('2','1','Набор для рисования','2008-06-03 13:40:37','1','b21ddffd1e9fe4716f5d1496c4e74400.jpg','a:5:{i:0;s:10:"3170050PK2";i:1;s:34:"бежевый, красный, синий, оранжевый";i:2;s:6:"84 шт.";i:3;s:65:"8 восковых карандашей, 8 красок и кисточка, в пластиковом футляре";i:4;s:19:"11.00, 12.55, 13.02";}','38','1','набор, краски','0','','','24','1'),
 ('4','1','Резак для бумаги','2008-06-03 13:55:00','1','30c14e99b4853a07e8718a176a5cbb3c.jpg','a:6:{i:0;s:10:"600010xPK2";i:1;s:39:"зеленый, красный, синий, желтый, черный";i:2;s:7:"280 шт.";i:3;s:43:"<p>Резак для бумаги с выдвижным лезвием</p>";i:4;s:0:"";i:5;s:15:"/images/rss.png";}','112','1','резак, пример','0','','','18.25','1'),
 ('5','2','Toyota Estima','2008-06-03 13:47:00','1','96bd390df9222bdc684ceec8afc94ec3.jpg','a:4:{i:0;s:7:"минивэн";i:1;s:9:"2,4 литра";i:2;s:4:"2000";i:3;s:1056:"<p>Второе поколение Toyota Estima, появившееся на рынке в 2000 году, лидирует среди минивэнов. Предшествующее поколение модели отличалось от нынешнего традиционным передним приводом. В комплектацию Estima входят две вариации двигателей: новый 4-цилиндровый рядный двигатель объемом 2.4 литра с системой газораспределения DOHC и 3-литровый 6-цилиндровый V-образный двигатель с той же системой газораспределения. Estima оснащается полным приводом с функцией активного контроля.</p>\r\n<p>Оригинальность экстерьера данного автомобиля проявляется в характерных жестких линиях кузова и раскосых передних фарах. Ширина и высота автомобиля стали меньше по сравнению с предыдущим поколением, но зато колесная база увеличилась до 40 мм.</p>\r\n<p>Две двери Estima снабжены механизмом &laquo;easy closer&raquo;, задние двери отрываются, скользя вдоль корпуса. В передней пассажирской двери установлении механизм автоматического открытия и закрытия. Второе поколение Estima с первым роднит возможность разместить восемь человек в салоне по модели &laquo;2-3-3&raquo;.</p>";}','4','1','авто, минивэн, тойота','0','','','0','1'),
 ('6','2','Mitsubishi Eterna','2008-06-03 13:48:39','1','7afbfacf9a4c4a9d64e0da2b31b880e5.jpg','a:4:{i:0;s:5:"седан";i:1;s:9:"1.8 литра";i:2;s:4:"1992";i:3;s:0:"";}','11','1','авто, седан','0','','','0','1'),
 ('7','2','Subaru Domingo','2008-06-03 13:51:24','1','db0297daef1de808feed34a75b5ea49b.jpg','a:4:{i:0;s:7:"минивэн";i:1;s:9:"1.2 литра";i:2;s:4:"1991";i:3;s:0:"";}','31','1','авто, минивэн','0','','','0','1');

INSERT INTO `#__user_autoawards` (`id`, `title`, `description`, `imageurl`, `p_comment`, `p_blog`, `p_forum`, `p_photo`, `p_privphoto`, `p_content`, `p_karma`, `published`) VALUES ('1','Медаль','Почетный член форума','aw.gif','0','0','100','0','0','0','0','1'),
 ('2','Грамота','Почетный комментатор сайта','aw4.gif','100','5','50','0','0','0','0','1');

INSERT INTO `#__user_friends` (`id`, `to_id`, `from_id`, `logdate`, `is_accepted`) VALUES ('1','1','21','2009-05-26 10:34:11','1');

INSERT INTO `#__user_groups` (`id`, `title`, `alias`, `is_admin`, `access`) VALUES ('1','Пользователи','registered','0','comments/add, comments/delete, content/add, board/autoadd'),
...
INSERT INTO `#__user_profiles` (`id`, `user_id`, `city`, `description`, `showmail`, `showbirth`, `showicq`, `karma`, `imageurl`, `allow_who`, `signature`, `gender`, `formsdata`, `email_newmsg`, `cm_subscribe`, `stats`) VALUES ('1','1','Москва','it, web, php','1','1','1','1','4a8b60d375f8abbebe53aa0bd881e8ef.jpg','all','','m','---\n22: Minimal techno\n24: Высшее\n','1','none','---\ncount: \n  comments: 9\n  forum: 6\n  photos: 0\n  board: 0\n  files_public: 0\n  files_private: 0\nrating: 15\n'),
...
INSERT INTO `#__users` (`id`, `group_id`, `login`, `nickname`, `password`, `email`, `icq`, `regdate`, `logdate`, `birthdate`, `is_locked`, `is_deleted`, `rating`, `points`, `last_ip`, `status`, `status_date`) VALUES ('1','2','admin','Администратор','2ca41752ccf4dbdb76d8fe88c488fd44','admin@cms.ru','100200300','2007-11-23 12:41:57','2009-08-31 13:18:13','1980-01-01','0','0','11','0','127.0.0.1','status the best','2009-08-29 14:08:32'),
 ('21','2','vasya','Василий','2ca41752ccf4dbdb76d8fe88c488fd44','r2@novator.ru','100200300','2008-07-16 16:31:48','2009-08-29 14:40:40','1980-01-01','0','0','11','0','127.0.0.1','Hello, World!','2009-08-20 17:17:37');
