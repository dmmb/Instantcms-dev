...
`published` int(11) DEFAULT '1' NOT NULL,
`version` varchar(6) DEFAULT '1.5' NOT NULL,
`system` int(11) DEFAULT '1' NOT NULL,
  PRIMARY KEY  (`id`)
...
`pagetitle` varchar(255) NOT NULL,
  PRIMARY KEY  (`id`),
  UNIQUE KEY `seolink` (`seolink`),
  FULLTEXT `title` (`title`, `content`),
  FULLTEXT `content` (`content`),
  FULLTEXT `title_2` (`title`, `content`),
  FULLTEXT `title_3` (`title`, `description`, `content`),
  FULLTEXT `title_4` (`title`, `description`, `content`)
...
`NSLevel` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1006;
...
`menu_id` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=547;
...
`is_comments` int(11) NOT NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1053;
...
`owner` varchar(10) DEFAULT 'photos',
  PRIMARY KEY  (`id`),
  FULLTEXT `title` (`title`, `description`)
...
`on_moderate` int(11) NOT NULL,
  PRIMARY KEY  (`id`),
  FULLTEXT `title` (`title`, `fieldsdata`)
) ENGINE=MyISAM AUTO_INCREMENT=11;
...
INSERT INTO `#__blog_posts` (`id`, `user_id`, `cat_id`, `blog_id`, `pubdate`, `title`, `feel`, `music`, `content`, `allow_who`, `edit_times`, `edit_date`, `published`, `seolink`) VALUES ('5','1','5','1','2009-09-07 11:50:16','Пример записи в блоге','','','[b]Блоги InstantCMS - это мощный и надежный инструмент для ваших публикаций:[/b]\r\n\r\n- Редактор BB-кода (скрытый текст, ссылки, цитаты, картинки);\r\n- Вставка изображений "на лету";\r\n- Неограниченное число рубрик;\r\n- Комментарии к записям;\r\n- Возможность ведения коллективных блогов;\r\n- Смайлы и теги;','0','3','2009-09-07 11:50:16','1','primer-zapisi-v-bloge'),
...
INSERT INTO `#__board_items` (`id`, `category_id`, `user_id`, `obtype`, `title`, `content`, `city`, `pubdate`, `pubdays`, `published`, `file`, `hits`) VALUES ('4','10','1','Предлагаю','Предлагаю свои услуги','Могу выносить мусор и мыть пол.','Москва','2009-10-26 14:11:18','10','1','550de8a5de9b5301133a815de31be00d.jpg','0'),
...
INSERT INTO `#__components` (`id`, `title`, `link`, `config`, `internal`, `author`, `published`, `version`, `system`) VALUES ('1','Каталог статей','content','---\nshowtitle: 0\nreaddesc: 0\nrating: 1\nperpage: 15\npt_show: 0\npt_disp: 0\npt_hide: 0\nautokeys: 1\nimg_small_w: 100\nimg_big_w: 200\nimg_sqr: 1\naf_on: 0\naf_delete: 1\naf_showlink: 1\naf_forum_id: 1\naf_hidecat_id: 2\n','0','InstantCMS team','1','1.5','1'),
...
INSERT INTO `#__forum_threads` (`id`, `forum_id`, `user_id`, `title`, `description`, `icon`, `pubdate`, `hits`, `closed`, `pinned`, `rel_to`, `rel_id`) VALUES ('12','1','1','Пример темы','','','2009-10-16 12:31:36','61','0','0','','0');

INSERT INTO `#__forums` (`id`, `category_id`, `title`, `description`, `auth_group`, `ordering`, `published`, `parent_id`, `NSLeft`, `NSRight`, `NSDiffer`, `NSIgnore`, `NSLevel`) VALUES ('1000','0','-- Корень форумов --','','0','1','0','0','1','8','','0','1'),
...
INSERT INTO `#__photo_files` (`id`, `album_id`, `title`, `description`, `pubdate`, `file`, `published`, `hits`, `showdate`, `comments`, `user_id`, `owner`) VALUES ('10','1','Закат на пляже','','2009-08-31 18:26:43','d0633d5a84f03a27f1b7d0419947e968.jpg','1','13','1','1','1','photos'),
...
INSERT INTO `#__ratings` (`id`, `item_id`, `points`, `ip`, `target`, `user_id`, `pubdate`) VALUES ('1','10','1','127.0.0.1','photo','27','2009-10-15 14:47:32'),
 ('2','38','1','127.0.0.1','blogpost','1','2009-10-21 12:52:32');

INSERT INTO `#__tags` (`id`, `tag`, `target`, `item_id`) VALUES ('255','пример','photo','11'),
 ('257','пример','photo','10'),
 ('256','фото','photo','10'),
 ('254','фото','photo','11'),
...
INSERT INTO `#__uc_cats` (`id`, `parent_id`, `title`, `description`, `published`, `fieldsstruct`, `view_type`, `fields_show`, `showmore`, `perpage`, `showtags`, `showsort`, `is_ratings`, `orderby`, `orderto`, `showabc`, `shownew`, `newint`, `filters`, `is_shop`, `NSLeft`, `NSRight`, `NSLevel`, `NSDiffer`, `NSIgnore`, `ordering`, `is_public`) VALUES ('1000','0','-- Корневая рубрика --','','1','','list','10','1','20','1','1','0','pubdate','desc','1','0','','0','0','1','6','0','0','0','1','0'),
 ('2','1000','Автомобили','','1','a:4:{i:0;s:15:"Тип кузова/~m~/";i:1;s:15:"Объем двигателя";i:2;s:16:"Год выпуска/~m~/";i:3;s:13:"Описание/~h~/";}','list','2','1','20','1','1','0','pubdate','desc','1','1','2 DAY','0','0','2','3','1','0','0','22','0'),
 ('1','1000','Канцелярские принадлежности','','1','a:6:{i:0;s:12:"Артикул/~m~/";i:1;s:10:"Цвета/~m~/";i:2;s:18:"Минимальная партия";i:3;s:13:"Описание/~h~/";i:4;s:11:"Размер/~m~/";i:5;s:12:"Скачать/~l~/";}','shop','4','0','11','0','0','0','hits','desc','0','0','123 HOUR','0','0','4','5','1','0','0','23','1');
...
INSERT INTO `#__uc_items` (`id`, `category_id`, `title`, `pubdate`, `published`, `imageurl`, `fieldsdata`, `hits`, `is_comments`, `tags`, `rating`, `meta_desc`, `meta_keys`, `price`, `canmany`, `user_id`, `on_moderate`) VALUES ('1','1','Карандаши','2008-06-03 13:38:55','1','b00117f6bca1efaaef37b44da87c1100.jpg','a:4:{i:0;s:7:"3130070";i:1;s:7:"бежевый";i:2;s:7:"191 шт.";i:3;s:64:"Набор для рисования: 12 цветных карандашей в картонной коробочке";}','29','1','пастель, карандаши','0','','','14.6','1','0','0'),
...
INSERT INTO `#__user_karma` (`id`, `user_id`, `sender_id`, `points`, `senddate`) VALUES ('1','1','27','1','2009-11-10 09:49:35');

INSERT INTO `#__user_photos` (`id`, `user_id`, `pubdate`, `title`, `description`, `allow_who`, `hits`, `imageurl`) VALUES ('1','27','2009-10-15','Florida','','all','2','cdf10c6b3c70a828c5f224861702a1ed.jpg');

INSERT INTO `#__user_profiles` (`id`, `user_id`, `city`, `description`, `showmail`, `showbirth`, `showicq`, `karma`, `imageurl`, `allow_who`, `signature`, `gender`, `formsdata`, `email_newmsg`, `cm_subscribe`, `stats`) VALUES ('1','1','Москва','Р.Хайнлайн, А.Азимов, А.Кларк, пить пиво, и всякое другое. А вообще, без разницы.','1','1','1','2','nopic.jpg','all','','m','---\n22: Р.Хайнлайн, А.Азимов, А.Кларк\n24: Высшее\n','1','none','---\ncount: \n  comments: 1\n  forum: 1\n  photos: 0\n  board: 2\n  files_public: 0\n  files_private: 0\nrating: 10\n'),
 ('21','21','Москва','живопись, &#8217;музыка&#8217;, всякая "всячина" однако','0','0','1','-2','nopic.jpg','all','','m','---\n22: |\n  &#8217;музыка&#8217;, всякая &quot;всячина&quot; однако\n24: Высшее\n','1','0','---\ncount: \n  comments: 1\n  forum: 0\n  photos: 0\n  board: 0\n  files_public: 0\n  files_private: 0\nrating: 0\n');

INSERT INTO `#__users` (`id`, `group_id`, `login`, `nickname`, `password`, `email`, `icq`, `regdate`, `logdate`, `birthdate`, `is_locked`, `is_deleted`, `rating`, `points`, `last_ip`, `status`, `status_date`) VALUES ('1','2','admin','Администратор','2ca41752ccf4dbdb76d8fe88c488fd44','admin@cms.ru','100200300','2007-11-23 12:41:57','2009-11-16 12:06:31','1980-01-01','0','0','10','0','127.0.0.1','status the best','2009-08-29 14:08:32'),
