            ...
            <tr>
                ...
                <td valign="top">
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="checklist">
                        <tr>
                            <td width="20">
                                <input type="radio" name="autokeys" id="autokeys1" <?php if ($do=='add'){ ?>checked="checked"<?php } ?> value="1"/>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td width="20">
                                <input type="radio" name="autokeys" id="autokeys3" value="3" <?php if ($do=='edit'){ ?>checked="checked"<?php } ?>/>
                            </td>
                            <td>
