...
--
-- Хост: localhost
-- Время создания: Мар 19 2010 г., 13:36
...
CREATE TABLE IF NOT EXISTS `cms_banlist` (
...
CREATE TABLE IF NOT EXISTS `cms_banner_hits` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cms_blogs` (`id`, `user_id`, `title`, `pubdate`, `allow_who`, `view_type`, `showcats`, `ownertype`, `premod`, `forall`, `owner`, `seolink`) VALUES
(1, 1, 'Пример блога', '2008-06-03 13:26:55', 'all', 'list', 1, 'single', 0, 1, 'user', 'primer-bloga'),
...
CREATE TABLE IF NOT EXISTS `cms_blog_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `blog_id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `cms_blog_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cms_blog_posts` (`id`, `user_id`, `cat_id`, `blog_id`, `pubdate`, `title`, `feel`, `music`, `content`, `allow_who`, `edit_times`, `edit_date`, `published`, `seolink`) VALUES
...
CREATE TABLE IF NOT EXISTS `cms_board_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_board_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(4, 10, 1, 'Предлагаю', 'Предлагаю свои услуги', 'Могу выносить мусор и мыть пол.', 'Москва', '2009-10-26 14:11:18', 10, 1, '550de8a5de9b5301133a815de31be00d.jpg', 1),
(5, 9, 1, 'Обменяю', 'Обменяю ВАЗ-2107 на Nissan Skyline GTR', 'Желательно новый и без доплаты.', 'Москва', '2009-10-26 14:14:24', 10, 1, '931f90c50adcea1ff18177bc22d4ceac.jpg', 3);
...
INSERT INTO `cms_category` (`id`, `parent_id`, `title`, `description`, `published`, `showdate`, `showcomm`, `orderby`, `orderto`, `modgrp_id`, `NSLeft`, `NSRight`, `NSLevel`, `NSDiffer`, `NSIgnore`, `ordering`, `maxcols`, `showtags`, `showrss`, `showdesc`, `is_public`, `photoalbum`, `seolink`) VALUES
...
CREATE TABLE IF NOT EXISTS `cms_codecheck` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cms_comments` (`id`, `parent_id`, `pid`, `user_id`, `target`, `target_id`, `guestname`, `content`, `pubdate`, `published`, `is_new`) VALUES
(1, 0, 0, 1, 'article', 30, '', 'Отличная статья! Большое спасибо автору!', '2009-05-20 17:42:14', 1, 1),
(2, 1, 0, 21, 'article', 30, '', 'Согласен с Вами, коллега!', '2009-05-20 17:42:40', 1, 1),
(16, 2, 0, 1, 'article', 30, '', '[code=php]$a = $b + 1;[/code]', '2010-03-17 11:30:47', 1, 1);
...
CREATE TABLE IF NOT EXISTS `cms_comments_votes` (
...
CREATE TABLE IF NOT EXISTS `cms_content_access` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_event_hooks` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_faq_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_faq_quests` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `pubdate` datetime NOT NULL,
  `published` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_filter_rules` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_forums` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `title` varchar(250) NOT NULL,
  ...
  `NSLevel` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=1005 ;
...
CREATE TABLE IF NOT EXISTS `cms_forum_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(250) NOT NULL,
  `published` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `cms_forum_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `post_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_forum_polls` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_forum_votes` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(17, 'mainmenu', 'Блоги', '/blog', 'component', 'blog', '_self', '', 5, 1, '0', -1, 'blog.gif', 10, 11, 1, '', 0, 1),
...
(39, 'mainmenu', 'Блог', '/blogs/primer-bloga/', 'blog', '1', '_self', '', 16, 1, '0', -1, '', 32, 33, 1, '', 0, 1),
...
CREATE TABLE IF NOT EXISTS `cms_modules_bind` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `module_id` int(11) NOT NULL,
  `menu_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=547 ;

--
-- Дамп данных таблицы `cms_modules_bind`
--

INSERT INTO `cms_modules_bind` (`id`, `module_id`, `menu_id`) VALUES
(329, 42, 0),
(249, 31, 0),
(533, 17, 1),
(347, 41, 18),
...
(24, '127.0.0.1', 'cc0cfcb3cb8d438a6deb3e5e5a33ef2d', '2010-03-19 13:35:26', 1, '', '/photos');
...
CREATE TABLE IF NOT EXISTS `cms_photo_albums` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) NOT NULL,
  `ordering` int(11) NOT NULL DEFAULT '1',
  `NSLeft` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=1034 ;
...
CREATE TABLE IF NOT EXISTS `cms_photo_files` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(10, 1, 'Закат на пляже', '', '2009-08-31 18:26:43', 'd0633d5a84f03a27f1b7d0419947e968.jpg', 1, 17, 1, 1, 1, 'photos'),
(11, 1, 'Флорида', '', '2009-08-31 18:27:33', '5e7a09ffcaa383df24d25d56c315f0d0.jpg', 1, 13, 1, 1, 1, 'photos');
...
CREATE TABLE IF NOT EXISTS `cms_polls_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `poll_id` int(11) NOT NULL,
  `answer_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_price_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
  `description` text NOT NULL,
  `published` int(11) NOT NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `cms_price_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  FULLTEXT KEY `title` (`title`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=892 ;
...
(3, 20, 1, '127.0.0.1', 'content', 1, '2010-03-17 13:15:44'),
(4, 26, 1, '127.0.0.1', 'content', 1, '2010-03-17 13:36:18');
...
CREATE TABLE IF NOT EXISTS `cms_tags` (
  ...
  `item_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=258 ;
...
CREATE TABLE IF NOT EXISTS `cms_uc_cart` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `session_id` varchar(50) NOT NULL,
  `item_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_uc_cats` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `parent_id` int(11) NOT NULL,
  `title` varchar(200) NOT NULL,
  `description` text NOT NULL,
  ...
  `is_public` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=cp1251 AUTO_INCREMENT=1001 ;

--
-- Дамп данных таблицы `cms_uc_cats`
--

INSERT INTO `cms_uc_cats` (`id`, `parent_id`, `title`, `description`, `published`, `fieldsstruct`, `view_type`, `fields_show`, `showmore`, `perpage`, `showtags`, `showsort`, `is_ratings`, `orderby`, `orderto`, `showabc`, `shownew`, `newint`, `filters`, `is_shop`, `NSLeft`, `NSRight`, `NSLevel`, `NSDiffer`, `NSIgnore`, `ordering`, `is_public`) VALUES
(1000, 0, '-- Корневая рубрика --', '', 1, '', 'list', 10, 1, 20, 1, 1, 0, 'pubdate', 'desc', 1, 0, '', 0, 0, 1, 6, 0, 0, 0, 1, 0),
...
CREATE TABLE IF NOT EXISTS `cms_uc_cats_access` (
  `cat_id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_uc_discount` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_uc_items` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `category_id` int(11) NOT NULL,
  `title` varchar(200) NOT NULL,
  `pubdate` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
CREATE TABLE IF NOT EXISTS `cms_uc_ratings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `item_id` int(11) NOT NULL,
  `points` int(11) NOT NULL,
  `ip` varchar(16) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_uc_tags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_upload_images` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `post_id` int(11) NOT NULL,
  `session_id` varchar(50) NOT NULL,
  `fileurl` varchar(250) NOT NULL,
...
INSERT INTO `cms_users` (`id`, `group_id`, `login`, `nickname`, `password`, `email`, `icq`, `regdate`, `logdate`, `birthdate`, `is_locked`, `is_deleted`, `rating`, `points`, `last_ip`, `status`, `status_date`) VALUES
(1, 2, 'admin', 'Администратор', '2ca41752ccf4dbdb76d8fe88c488fd44', 'admin@cms.ru', '100200300', '2007-11-23 12:41:57', '2010-03-19 13:17:22', '1980-01-01', 0, 0, 20, 0, '127.0.0.1', 'status the best', '2009-08-29 14:08:32'),
...
CREATE TABLE IF NOT EXISTS `cms_users_activate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pubdate` datetime NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_autoawards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(200) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_awards` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `pubdate` datetime NOT NULL,
  `title` varchar(250) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_clubs` (
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_friends` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `cms_user_karma` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_msg` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `to_id` int(11) NOT NULL,
  `from_id` int(11) NOT NULL,
  `senddate` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cms_user_photos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
...
(1, 1, 'Москва', 'Р.Хайнлайн, А.Азимов, А.Кларк, пить пиво, и всякое другое. А вообще, без разницы.', 1, 1, 1, 2, 'nopic.jpg', 'all', '', 'm', '---\n22: Р.Хайнлайн, А.Азимов, А.Кларк\n24: Высшее\n', 1, 'none', '---\ncount: \n  comments: 2\n  forum: 1\n  photos: 0\n  board: 2\n  files_public: 0\n  files_private: 0\nrating: 20\n'),
...
CREATE TABLE IF NOT EXISTS `cms_user_wall` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
