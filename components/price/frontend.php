...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	if ($do=='finish'){
		...
		if(!empty($_REQUEST['customer_fio'])) { $customer['fio'] = $_REQUEST['customer_fio']; } else { $error .= $_LANG['SET_YOUR_NAME'].'<br/>'; }
		if(!empty($_REQUEST['customer_phone'])) { $customer['phone'] = $_REQUEST['customer_phone']; } else { $error .= $_LANG['SET_YOUR_PHONE'].'<br/>'; }
