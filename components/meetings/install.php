...
// ========================================================================== //
    ...
    function info_component_meetings(){

        //Описание компонента

        $_component['title']        = 'Встречи - демо компонент';                   //название
        $_component['description']  = 'Пример реализации установщика компонентов';  //описание
        ...
        $_component['version']      = '1.5';                                        //текущая версия
...
// ========================================================================== //
     ...
     */
    function install_component_meetings(){
...
// ========================================================================== //
     ...
     */
    function upgrade_component_meetings(){
