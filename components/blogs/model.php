...
/* ==================================================================================================== */
   ...
   //
   // этот метод вызываетс€ компонентом comments при создании нового комментари€
   //
   // метод должен вернуть массив содержащий ссылку и заголовок поста, к которому
   // добавл€етс€ комментарий
   //
...
/* ==================================================================================================== */
    ...
    // 
    // этот метод €вл€етс€ хуком и вызываетс€ при изменении рейтинга объекта blogpost
...
/* ==================================================================================================== */
    ...
    public function getBlogSeoLink($blog){
        ...
        //ќбновл€ем пути всех постов этого блога
...
/* ==================================================================================================== */
    ...
    public function getBlogs($ownertype, $page, $perpage){
        ...
        //ƒобавл€ем к запросу ограничение по типу хоз€ина (пользователи или клубы)
        if ($ownertype!='all') { 
		...
		// если передали страницу и кол-во страниц, то добавл€ем LIMIT
...
/* ==================================================================================================== */
    ...
    public function getPosts($blog_id, $page=0, $perpage=0, $category_id=0, $owner='user'){
        ...
        //ѕолучаем записи, относ€щиес€ к нужной странице блога
        $sql = "SELECT p.*, DATE_FORMAT(p.pubdate, '%d-%m-%Y (%H:%i)') as fpubdate, 
