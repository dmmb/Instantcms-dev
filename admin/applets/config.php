	...
	<form action="/admin/index.php?view=config" method="post" name="CFGform" target="_self" id="CFGform" style="margin-bottom:30px">
			...
			<table width="720" border="0" cellpadding="5">
				...
				<tr>
					<td valign="middle">
						...
						<span class="hinttext">Отображается на главной странице при отключении сайта</span>
				...
				<tr>
					<td>
						...
						<span class="hinttext">Адрес от имени которого будут рассылаться уведомления пользователям</span>
                    </td>
					<td>
			...
			<table width="720" border="0" cellpadding="5">
                <tr>
    				<td>
						...
						<span class="hinttext">Если не указан, будет совпадать с названием сайта</span>
                    </td>
                    <td width="350" valign="top">
				...
				<tr>
					<td valign="top">
						...
						<div class="hinttext" style="margin-top:4px"><a style="color:#09C" href="http://tutorial.semonitor.ru/#5" target="_blank">Как подбирать ключевые слова?</a></div>
                    </td>
					<td>
				...
				<tr>
					<td valign="top">
						...
						<div class="hinttext" style="margin-top:4px"><a style="color:#09C" href="http://tutorial.semonitor.ru/#219" target="_blank">Как составлять описание?</a></div>
                    </td>
					<td>
			...
			<table width="720" border="0" cellpadding="5">
				<tr>
					<td valign="top">
                        ...
                        <div style="margin-top:2px">
                            <a style="color:#09C" target="_blank" href="http://instantcms.ru/content/0/read82.html">Заказать уникальный шаблон</a>
                        </div>
					</td>
					<td>
                        ...
                        <div style="margin:5px">
                            <div><a href="index.php?view=editor&amp;lang=css&amp;file=/templates/<?php echo $_CFG['template']?>/css/styles.css">Редактировать CSS</a></div>
                            <div><a href="index.php?view=editor&amp;lang=php&amp;file=/templates/<?php echo $_CFG['template']?>/template.php">Редактировать PHP</a></div>
                            <div><a href="index.php?view=editor&amp;lang=html&amp;file=/templates/<?php echo $_CFG['template']?>/positions.txt">Редактировать позиции</a></div>
                        </div>
					</td>
				</tr>
				<tr>
					<td>
						...
						<span class="hinttext">Показывается при первом посещении сайта </span>
					</td>
					<td valign="top">
						<input name="splash" type="radio" value="0" <?php if (@!$_CFG['splash']) { echo 'checked="checked"'; } ?>/>	Скрыть
						<input name="splash" type="radio" value="1" <?php if (@$_CFG['splash']) { echo 'checked="checked"'; } ?>/> Показывать [<a href="index.php?view=editor&lang=php&file=/core/splash/splash.php">редактор</a>] 
					</td>
				</tr>
				<tr>
		...
		<div id="mail">
			<table width="720" border="0" cellpadding="5" style="margin-top:15px;">
				...
				<tr>
					<td>
						<strong>SMTP авторизация:</strong><br/>
					</td>
					<td width="350">
				...
				<tr>
					<td>
						<strong>SMTP пользователь:</strong><br/>
					</td>
					<td width="350">
		...
		<div id="other">
			<table width="720" border="0" cellpadding="5">
				<tr>
					<td valign="top">
						<strong>Плавная смена страниц </strong><br />
						<span class="hinttext">Визуальный эффект, только в IE </span>
					</td>
					<td width="350" valign="top">
						<input name="page_fx" type="radio" value="1" <?php if (@$_CFG['page_fx']) { echo 'checked="checked"'; } ?>/> Да
						<input name="page_fx" type="radio" value="0" <?php if (@!$_CFG['page_fx']) { echo 'checked="checked"'; } ?>/> Нет 
					</td>
				</tr>
				<tr>
					<td>
						<strong>Показывать глубиномер?</strong><br />
						<span class="hinttext">Отображает путь к разделу, <br />
						в котором находится посетитель </span>
					</td>
					<td>
				...
				<tr>
					<td><strong>Глубиномер на главной странице: </strong><br /></td>
					<td>
				...
				<tr>
					<td><strong>Просмотр профилей только зарегистрированным: </strong><br /></td>
					<td>
						<input name="user_view_prof" type="radio" value="1" <?php if (@$_CFG['user_view_prof']) { echo 'checked="checked"'; } ?>/> Да
						<input name="user_view_prof" type="radio" value="0" <?php if (@!$_CFG['user_view_prof']) { echo 'checked="checked"'; } ?>/>	Нет 
					</td>
				</tr>
			</table>
        </div>
