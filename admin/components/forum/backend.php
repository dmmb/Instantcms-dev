...
/*********************************************************************************************/
	...
	if($opt=='saveconfig'){	
		...
		$cfg['karma'] = $_REQUEST['karma'];		
		$cfg['pp_thread'] = $_REQUEST['pp_thread'];					
		$cfg['pp_forum'] = $_REQUEST['pp_forum'];		

		$cfg['showimg'] = $_REQUEST['showimg'];		

		$cfg['img_on'] = $_REQUEST['img_on'];		
		$cfg['img_max'] = $_REQUEST['img_max'];
		
		$cfg['fast_on'] = $_REQUEST['fast_on'];		
		$cfg['fast_bb'] = $_REQUEST['fast_bb'];		
		
		$cfg['fa_on'] = $_REQUEST['fa_on'];		
		$cfg['fa_allow'] = $_REQUEST['fa_allow'];		
		$cfg['fa_max'] = $_REQUEST['fa_max'];		
		$cfg['fa_ext'] = $_REQUEST['fa_ext'];
		$cfg['fa_size'] = $_REQUEST['fa_size'];												
