...
/*********************************************************************************************/
	...
	cpAddPathway('Категории прайса', '?view=modules&do=edit&id='.$_REQUEST['id']);
      ...
      <form action="index.php?view=modules&do=config&id=<?php echo $_REQUEST['id'];?>" method="post" name="optform" target="_self" id="form1">
        <table width="501" border="0" cellpadding="10" cellspacing="0" class="proptable">
          ...
          <tr>
            ...
            <div>Оставьте поле пустым, если иконка не нужна</div>            </td>
            <td valign="top"><label>
			  ...
			  <br/><span style="color:#FF0000">Файл иконки не найден!</span>
			  <?php } ?>
            </label></td>
          </tr>
        </table>
