...
var sh = {
	...
	config : {
		...
		strings : {
			expandSource : 'исходный код',
			viewSource : 'исходный код',
			copyToClipboard : 'скопировать в буфер обмена',
			copyToClipboardConfirmation : 'Код скопирован в буфер обмена.',
			print : 'печать',
			help : '?',
			alert: 'Подсветка синтаксиса\n\n',
			noBrush : 'Неизвестный язык: ',
			brushNotHtmlScript : 'Неизвестная опция: ',
			
			// this is populated by the build script
			aboutDialog : '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" /><title>SyntaxHighlighter</title></head><body style="font-family:Geneva,Arial,Helvetica,sans-serif;background-color:#fff;color:#000;font-size:1em;text-align:center;"><div style="text-align:center;margin-top:3em;"><div style="font-size:xx-large;">SyntaxHighlighter</div><div style="font-size:.75em;margin-bottom:4em;"><div>версия 2.1.364 (Октябрь 15 2009)</div><div><a href="http://alexgorbatchev.com" target="_blank" style="color:#0099FF;text-decoration:none;">http://alexgorbatchev.com</a></div></div><div>Плагин для подсветки кода на JavaScript.</div><div>Все права защищены 2004-2009 Alex Gorbatchev.</div></div></body></html>'
		},
