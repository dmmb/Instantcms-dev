...
--
-- Хост: localhost
-- Время создания: Окт 11 2010 г., 18:23
...
(3, 0, 0, 1, 'article', 31, '', 'str1\r\nstr2\r\nstr3', '2010-05-27 13:14:04', 1, 1, 'Останцовый лакколит: основные моменты', '/stati/geologija/ostancovyi-lakkolit-osnovnye-momenty.html');
...
(13, 'mainmenu', 'FAQ', '/faq', 'component', 'faq', '_self', '', 6, 1, '0', -1, '27.gif', 12, 13, 1, '', 0, 1),
(15, 'mainmenu', 'Люди', '/users', 'component', 'users', '_self', '', 11, 1, '0', -1, 'group.gif', 22, 23, 1, '', 0, 1),
(16, 'mainmenu', 'Регистрация', '/registration', 'component', 'registration', '_self', '', 13, 0, '0', 8, 'tag.gif', 26, 27, 1, '', 0, 1),
...
(20, 'mainmenu', 'Фото', '/photos', 'component', 'photos', '_self', '', 3, 1, '0', -1, '20.gif', 6, 7, 1, '', 0, 1),
(21, 'mainmenu', 'Статьи', '/stati', 'category', '6', '_self', '', 2, 1, '0', -1, '22.gif', 4, 5, 1, '', 0, 1),
(22, 'mainmenu', 'Прайс-лист', '/price', 'component', 'price', '_self', '', 7, 0, '0', -1, 'objects043.gif', 14, 15, 1, '', 0, 1),
(23, 'mainmenu', 'Каталог', '/catalog', 'component', 'catalog', '_self', '', 8, 1, '0', -1, 'objects048.gif', 16, 17, 1, '', 0, 1),
(25, 'mainmenu', 'Поиск по сайту', '/search', 'component', 'search', '_self', '', 10, 0, '0', -1, 'objects018.gif', 20, 21, 1, '', 0, 1),
(27, 'mainmenu', 'Админка', '/admin/', 'link', '/admin/', '_blank', '', 14, 0, '0', 2, 'options.gif', 28, 29, 1, '', 0, 1),
(37, 'mainmenu', 'Объявления', '/board', 'component', 'board', '_self', '', 9, 1, '0', -1, 'objects038.gif', 18, 19, 1, '', 0, 1),
...
(25, 'sidebar', 'Голосования', 'Голосования', 1, 'mod_polls', 7, 1, 1, 0, '---\nshownum: 0\npoll_id: 2\n', 1, '', -1, 0, 1, 'HOUR', 'module.tpl', 0),
...
(20, 'topright', 'Авторизация', 'Авторизация', 1, 'mod_auth', 20, 1, 1, 0, '---\nautolog: 1\npassrem: 1\n', 1, '', -1, 0, 1, 'MINUTE', 'module.tpl', 0),
...
(61, 'sidebar', 'Последние комментарии', 'Последние комментарии', 1, 'mod_comments', 3, 1, 1, 0, '---\nshownum: 10\nminrate: 0\nshowdesc: 1\nshowrss: 1\ntargets: \n  faq: faq\n  catalog: catalog\n  boarditem: boarditem\n  blog: blog\n  article: article\n  palbum: palbum\n  photo: photo\n  userphoto: userphoto\n', 1, '', -1, 0, 1, 'MINUTE', 'module.tpl', 0),
...
(64, 'maintop', 'Новое в блогах', 'Новое в блогах', 1, 'mod_latestblogs', 1, 1, 1, 0, '---\nshownum: 4\nshowrss: 1\nmenuid: 17\nminrate: 0\n', 1, '', -1, 0, 1, 'HOUR', 'module.tpl', 0),
(65, 'top', 'Популярное в блогах', 'Популярное в блогах', 1, 'mod_bestblogs', 32, 1, 0, 0, '---\nnamemode: blog\nshownum: 10\n', 1, '', -1, 0, 1, 'HOUR', 'module.tpl', 0),
(66, 'topright', 'Меню пользователя', 'Меню пользователя', 1, 'mod_usermenu', 5, 0, 1, 0, '---\navatar: 1\nshowtype: text\n', 1, '', -1, 0, 1, 'HOUR', 'module.tpl', 0),
...
(136, '127.0.0.1', 'b8d571c8eefcc8b41686d2a53d478dba', '2010-10-11 18:22:11', 1, '', '/blogs/primer-bloga-admina/pochemu-netrivialno-umnozhenie-dvuh-vektorov-vektornoe.html');
...
(1, 2, 'admin', 'Администратор', '2ca41752ccf4dbdb76d8fe88c488fd44', 'admin@cms.ru', '100200300', '2007-11-23 12:41:57', '2010-10-11 16:46:44', '1980-01-01', 0, 0, 15, 0, '127.0.0.1', 'I love InstantCMS', '2009-08-29 14:08:32', 0, '2010-08-12 13:53:58'),
...
(22, 1, 'vasya', 'Василий2', '2ca41752ccf4dbdb76d8fe88c488fd44', 'vasya@vasya.com', '', '2010-06-17 10:26:46', '2010-10-08 17:53:49', '1980-01-01', 0, 0, 0, 0, '127.0.0.1', '', '0000-00-00 00:00:00', 0, '2010-08-12 13:53:58'),
...
(3, 22, -1, '2010-10-08 17:53:22', 0, '[b]Получено предложение дружбы[/b]. Вы можете посмотреть его в своем [url=http://icms/users/vasya]профиле[/url].'),
(4, 1, 22, '2010-10-08 17:53:45', 0, 'привет&#039;c');
