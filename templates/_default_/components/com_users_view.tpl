		...
		<tr>
			...
			{* ========================= —“¿“»—“» ¿ œŒÀ‹«Œ¬¿“≈À≈… ============================*}				
				...
				<div class="stat_block">
					...
					<div class="body">
						<ul>
							<li><a href="javascript:void(0)" rel=înofollowî onclick="searchGender('m', {$menuid})">{$gender_stats.male|spellcount:$LANG.MALE1:$LANG.MALE2:$LANG.MALE10}</a></li>
							<li><a href="javascript:void(0)" rel=înofollowî onclick="searchGender('f', {$menuid})">{$gender_stats.female|spellcount:$LANG.FEMALE1:$LANG.FEMALE2:$LANG.FEMALE10}</a></li>
