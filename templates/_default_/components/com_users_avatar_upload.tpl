...
<form enctype="multipart/form-data" action="/users/{$menuid}/{$id}/avatar.html" method="POST">
...
<p><a href="/users/{$menuid}/{$id}/select-avatar.html" class="select-avatar">{$LANG.SELECT_AVATAR_FROM_COLL}</a></p>