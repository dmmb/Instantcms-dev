    ...
    <tr>
        <td valign="top" width="240" style="<?php if ($hide_cats){ ?>display:none;<?php } ?>" id="cats_cell">
            ...
            <div class="cat_add_link">
                <div>
                    <a href="?view=cats&opt=add" style="color:#09C">Добавить категорию</a>
                </div>
            </div>
            <div class="cat_link">
                <div>
                        ...
                        <td width="">
                            ...
                            <span style="padding-left: 15px;">
                                ...
                                <?php if($category_id){ ?>
                                    ...
                                    <a title="Удалить раздел" onclick="jsmsg('Удалить раздел?', '?view=cats&do=delete&id=<?php echo $component_id; ?>')" href="#">
                    ...
                    <div style="margin-top:4px;padding-top:4px;">
                        <table class="" cellpadding="5" border="0" height="40">
                            <tr>
                                ...
                                <td class="sel_pub">
                                    <input type="button" name="" value="Показать" onclick="sendShopForm(<?php echo $_REQUEST['id']; ?>, 'show_item');" />
                                    <input type="button" name="" value="Скрыть" onclick="sendShopForm(<?php echo $_REQUEST['id']; ?>, 'hide_item');" />
                                </td>
                                <td class="sel_pub">
